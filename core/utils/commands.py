...
async def set_commands(bot: Bot):
    ...
    await bot.set_my_commands(moderator_commands, BotCommandScopeChat(list(ADMIN_ID[1])))
    await bot.set_my_commands(admin_commands, BotCommandScopeChat(list(ADMIN_ID[0])))